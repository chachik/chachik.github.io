...
function initMobileNav() {
	...
	jQuery('.main-nav a[href^="#section-"]:not([href="#"])').on('click touchstart', function() {
		if(menuInst && menuInst.isOpened()) {
			menuInst.hide();
		}
	});
}
...
function initAnchors() {
	var anchorInstance1 = new SmoothScroll({
		anchorLinks: 'a[href^="#section-"]:not([href="#"])',
	...
	ResponsiveHelper.addRange({
		'1423..': {
			on: function() {
				anchorInstance1.options.extraOffset = 108;
			}
		},
		'1024..': {
			on: function() {
				anchorInstance1.options.extraOffset = 106;
			}
		},
		'768..': {
			on: function() {
				anchorInstance1.options.extraOffset = 79;
			}
		},
		'..767': {
			on: function() {
				anchorInstance1.options.extraOffset = 55;
			}
		}
	});
}

// initialize parallax block
	...
	SmoothScroll.prototype = {
		...
		attachEvents: function() {
			...
			if (!this.options.useNativeAnchorScrolling) {
				this.anchorLinks.on('click touchstart', this.clickHandler);
			}
		},
